...
pub struct OApiLink<LinkExt, ServerExt, ServerVarExt> {
    ...
    #[serde(default)]
    server: Option<OApiServer<ServerExt, ServerVarExt>>,
    #[serde(flatten)]
    extension: LinkExt,
}

// impl<LinkExt, ServerExt, ServerVarExt> OApiLink<LinkExt, ServerExt, ServerVarExt>
// where
...
// impl<LinkExt, ServerExt, ServerVarExt> OApiCheckTrait for OApiLink<LinkExt, ServerExt, ServerVarExt>
// where
//     LinkExt: OApiExtensionRequirements,
//     ServerExt: OApiExtensionRequirements,
//     ServerVarExt: OApiExtensionRequirements,
